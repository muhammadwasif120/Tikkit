...
export const metadata: Metadata = {
  title: 'DJs — Book for Events · Tikkit X',
  description: 'Book verified DJs for concerts, festivals, corporate events and private parties through Tikkit X.',
}
...
export default async function DJsPage() {
  ...
  return <ArtistDirectoryClient artists={artists ?? []} userId={user?.id ?? null} isVerifiedOrganiser={isVerifiedOrganiser} category="dj" />
}
