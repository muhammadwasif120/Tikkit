...
export const metadata: Metadata = {
  title: 'Musicians & Bands — Book for Events · Tikkit X',
  description: 'Book verified musicians, bands, and live performers for your event through Tikkit X.',
}
...
export default async function MusiciansPage() {
  ...
  return <ArtistDirectoryClient artists={artists ?? []} userId={user?.id ?? null} isVerifiedOrganiser={isVerifiedOrganiser} category="musician" />
}
