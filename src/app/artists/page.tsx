...
export const metadata: Metadata = {
  title: 'Artists — Book Live Talent · Tikkit X',
  description: 'Discover and book verified DJs, musicians, and comedians for your event through Tikkit X.',
}
...
export default async function ArtistDirectoryPage() {
  ...
  // Is current user a verified organiser?
