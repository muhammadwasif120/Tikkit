...
const CSS = `
  .vb-wrap { display:flex; flex-wrap:wrap; gap:8px; align-items:center; }
  ...
  .vb-badge.sm { padding:3px 9px; font-size:10px; gap:4px; }
  .vb-badge.lg { padding:7px 16px; font-size:13px; gap:7px; }

  .vb-verified {
    background:rgba(34,197,94,0.1); border-color:rgba(34,197,94,0.3); color:#22C55E;
  }
  .vb-unverified {
    background:rgba(75,85,99,0.12); border-color:rgba(75,85,99,0.25); color:#4B5563;
  }
  .vb-score {
    background:rgba(250,204,21,0.1); border-color:rgba(250,204,21,0.3); color:#FACC15;
  }
`
