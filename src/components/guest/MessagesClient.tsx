  ...
  if (threads.length === 0) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', flexDirection: 'column', gap: 12, padding: 24 }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 13, margin: 0, textAlign: 'center' }}>Register for events to chat with organizers.</p>
      </div>
    )
  }
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 2 }}>
                  <p style={{
                    color: 'var(--text-primary)', fontSize: 14, fontWeight: unread ? 800 : 600,
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
                    ...
                    {unread && (
                      <span style={{
                        ...
                        boxShadow: '0 0 6px rgba(var(--brand-blue-rgb),0.8)',
                      }} />
                    )}
                  </div>
                </div>
                ...
                {t.lastMessage ? (
                  <p style={{
                    color: unread ? 'var(--text-primary)' : 'var(--text-muted)', fontSize: 12, margin: 0,
  ...
  const ChatThread = selectedThread ? (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        borderBottom: '1px solid var(--guest-border)', flexShrink: 0,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ color: 'var(--text-primary)', fontSize: 14, fontWeight: 700, margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
      ...
      <div style={{
        ...
        scrollbarWidth: 'thin', scrollbarColor: 'var(--guest-border) transparent',
      }}>
        {loadingThread ? (
            ...
            return (
              <div key={msg.id} style={{
                ...
                <div style={{
                  ...
                  fontSize: 9, fontWeight: 800, color: isMe ? 'var(--brand-blue)' : '#A855F7',
                }}>
                  {initials}
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  <p style={{ color: 'var(--text-muted)', fontSize: 10, fontWeight: 600, margin: 0, textAlign: isMe ? 'right' : 'left' }}>
                    {msg.sender_name}
                  </p>
                  ...
                  <p style={{ color: 'var(--text-muted)', fontSize: 9, margin: 0, textAlign: isMe ? 'right' : 'left' }}>
      ...
      <div style={{ borderTop: '1px solid var(--guest-border)', background: 'var(--surface-card)', flexShrink: 0 }}>
        ...
        <div style={{ padding: '12px 14px calc(12px + env(safe-area-inset-bottom))', display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              width: 36, height: 36, borderRadius: 10, background: 'var(--brand-blue)',
